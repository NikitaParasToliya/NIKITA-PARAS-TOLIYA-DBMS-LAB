...
create table text(book_isbn int primary key,book_title varchar(20),publisher varchar(10),author varchar(10));
...
insert into text values(7,"database basics","princeton","shawn");
...
from course c,book_adoption b, text t where c.course_no=b.course_no
